      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Padding(
              padding:  EdgeInsets.only(left: width/41.27, right: width/19.27, top: height/5.503),
              child: Form(
                key: formkey,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(height/20.636),color: Colors.blueGrey),height: height/27.5,width: width/2.45,
                      child: Padding(
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: width/9.818, right: width/19.27),
                      child: Row(
                        children: <Widget>[
                          RaisedButton(
                            child: Text('Low'),
                            textColor: Colors.white,
                            color: cubic.selectedIndex == 0
                                ? Colors.blueGrey
                                : Colors.grey[400],
                            onPressed: () {
