...
Widget buildItemperson(
        height, width, context, numberpriority, typepriority, sumpriority) =>
    Padding(
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(height / 82.545),
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(right: width / 39.3),
                      child: Icon(
            ...
            Padding(
              padding:
                  EdgeInsets.only(left: width / 30.21, right: width / 30.21),
              child: Container(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return ConditionalBuilder(
                      condition:
                          ActivateCubic.get(context).persons[index].priority ==
                              numberpriority,
                      builder: (context) {
                        return Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Checkbox(
                                ...
                                value: ActivateCubic.get(context)
                                    .persons[index]
                                    .valueHigh,
                                onChanged: (value) {
                                  print(value);
                                  ActivateCubic.get(context).updatePersonDone(
                                      ActivateCubic.get(context)
                                          .persons[index]
                                          .id!,
                                      value!,
                                      index);
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () {
                                  ActivateCubic.get(context).DeleteValueOnhive(
                                      ActivateCubic.get(context)
                                          .persons[index]
                                          .id,
                                      index);
  ...
  width,
    ...
    Scaffold(
      body: SingleChildScrollView(
        ...
        buildItemhome(ListDay(), context, height, width, 'Keeping a To-Do List',
            'image/list.jpg'),
        SizedBox(
          height: height / 33.018,
        ),
...
Widget buildItemhome(Widget widget, context, height, width, text, image) =>
    InkWell(
      onTap: () {
      ...
      child: Container(
        ...
        height: height / 4.86,
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(height / 20.64),
          color: Colors.blueGrey,
        ),
        child: Padding(
  ...
  width,
    ...
    Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return ConditionalBuilder(
            condition: ActivateCubic.get(context).persons[index].priority == 3,
            builder: (context) => Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  ActivateCubic.get(context).persons[index].valueHigh == false
                      ? Expanded(
                          child: AutoSizeText(
                            ActivateCubic.get(context)
                                .persons[index]
                            ...
                            style: Theme.of(context)
                                ...
                                .headline4!
                                .copyWith(
                                    color: Colors.blueGrey[400], fontSize: 18),
                          ),
                        )
                      : Expanded(
                          child: AutoSizeText(
...
Widget buildDream(context, height, width, textController, persons, formkey) =>
    Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
                            ...
                            Card(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: AutoSizeText(
                                      'write what  you want to achieve in the future :',
                ...
                child: Container(
                  child: Column(
                    children: [
                      ...
                      ActivateCubic.get(context).persons.isNotEmpty
                          ? buildItemDream(context, height, width)
                          : Container(),
                    ],
                  ),
                ),
...
Widget buildItemRules(context, height, width, titles) => Padding(
      padding: EdgeInsets.only(
          top: height / 103.03, right: width / 19.27, left: width / 19.27),
      child: Container(
        child: ListView.separated(
            shrinkWrap: true,
            physics: NeverScrollableScrollPhysics(),
